// disini ada 4 oop encapsulation constructor overloading dan polymorphism
...
public class Perpustakaan {
    ...
    public boolean pinjamBuku(String kodeBuku, String idAnggota) {
        ...
        // association: Transaksi memiliki relasi dengan Buku dan Anggota
        ...
        try (BufferedReader readerAnggota = new BufferedReader(new FileReader(FILE_ANGGOTA))) {
            ...
            while ((baris = readerAnggota.readLine()) != null) {
                ...
                try {
                    ...
                    switch (kodeJenis) {
                        case "M" -> daftarAnggota.add(new Mahasiswa(id, nama));
                        case "D" -> daftarAnggota.add(new Dosen(id, nama));
                        default -> System.out.println("Tipe anggota tidak dikenali, baris dilewati: " + baris);
                    }
